...
const quiz: {
    ...
    },
    {
        name: "question_2",
        type: "list",
        message: "Q2.Which of the following characters is commonly allowed in variables names in Typscript?",
        choices: ["$", "@", "#", "&"]
    },
    {
        name: "question_3",
    ...
    },
    {
        name: "question_5",
        type: "list",
        message: "Q5.What is the correct way to check if two values are not equal in Typescript?",
